...
const Icons: any = {
  ...
  heartBookmarkOutline: (
    <g>
      <path d="M15.670 5.999 A1.500 1.500 0 1 0 18.670 5.999 A1.500 1.500 0 1 0 15.670 5.999 Z" />
      <path d="M13.96,12.545a3.525,3.525,0,0,0-1.936,5.965l5.114,5.335a.5.5,0,0,0,.722,0l5.106-5.327a3.525,3.525,0,1,0-4.985-4.986l-.305.3a.25.25,0,0,1-.354,0l-.3-.3A3.5,3.5,0,0,0,13.96,12.545Z" />
      <path d="M11.248,19.868a.247.247,0,0,0-.178-.077.251.251,0,0,0-.179.073L9.877,20.878a1.025,1.025,0,0,1-1.414,0L2.291,14.706a1,1,0,0,1,0-1.414l11-11A1,1,0,0,1,14,2H20.67a.5.5,0,0,1,.5.5V9.17a1,1,0,0,1-.293.708l-.7.7a.25.25,0,0,0,.182.427h.1a5.071,5.071,0,0,1,1.752.309.071.071,0,0,0,.076-.016A2.978,2.978,0,0,0,23.17,9.17V2a2,2,0,0,0-2-2H14a2.98,2.98,0,0,0-2.122.879l-11,11a3,3,0,0,0,0,4.242l6.172,6.172a3,3,0,0,0,4.242,0l.992-.991a.251.251,0,0,0,0-.35Z" />
    </g>
  ),
  heartBookmarkFilled: (
    <g>
      <path d="M19.105,8.413A3.985,3.985,0,0,0,20.091,6V2a2,2,0,0,0-2-2h0L13.833.005a3.945,3.945,0,0,0-2.415,1L.592,11.833a2,2,0,0,0,0,2.829L5.428,19.5a1.976,1.976,0,0,0,1.406.581h.011a1.976,1.976,0,0,0,1.411-.6L9.268,18.45a.5.5,0,0,0,.1-.539,5.02,5.02,0,0,1,6.448-6.578.494.494,0,0,0,.535-.108ZM12.591,5.5a2,2,0,1,1,2,2A2,2,0,0,1,12.591,5.5Z" />
      <path d="M13.46,12.545a3.524,3.524,0,0,0-1.935,5.965l5.113,5.335a.5.5,0,0,0,.722,0l5.107-5.328a3.525,3.525,0,0,0-4.986-4.985l-.305.3a.25.25,0,0,1-.353,0l-.3-.3A3.5,3.5,0,0,0,13.46,12.545Z" />
    </g>
  ),
  tag: (
    <g>
  ...
  socialJetLag: (
    <g>
      <path d="M10.5,17.75a.5.5,0,0,0,.5-.5v-3.5a5.5,5.5,0,0,0-11,0v3.5a.5.5,0,0,0,.5.5H2.31a.249.249,0,0,1,.249.229L3,23.291a.5.5,0,0,0,.5.459h4a.5.5,0,0,0,.5-.459l.443-5.312a.249.249,0,0,1,.249-.229Z" />
      <path d="M2.000 3.750 A3.500 3.500 0 1 0 9.000 3.750 A3.500 3.500 0 1 0 2.000 3.750 Z" />
      <path d="M11.169,20.454a.76.76,0,0,0-.164.563.77.77,0,0,0,.308.533l2.877,2.02a.98.98,0,0,0,1.084.032l7.855-4.878A1.869,1.869,0,0,0,24,17.119a1.793,1.793,0,0,0-.105-.6,1.869,1.869,0,0,0-1.35-1.211h0a1.8,1.8,0,0,0-1.41.269l-2,1.365a.25.25,0,0,1-.228.027l-4.653-1.732a.831.831,0,0,0-.782.112L12.586,16a1.138,1.138,0,0,0-.139.13.823.823,0,0,0-.2.6.856.856,0,0,0,.35.611l2.7,1.67a.251.251,0,0,1,.017.414l-.957.709a.25.25,0,0,1-.276.015l-1.17-.69a.782.782,0,0,0-.747.131l-.867.728A1.227,1.227,0,0,0,11.169,20.454Z" />
      <path d="M10.5,17.75a.5.5,0,0,0,.5-.5v-3.5a5.5,5.5,0,0,0-11,0v3.5a.5.5,0,0,0,.5.5H2.31a.249.249,0,0,1,.249.229L3,23.291a.5.5,0,0,0,.5.459h4a.5.5,0,0,0,.5-.459l.443-5.312a.249.249,0,0,1,.249-.229Z" />
      <path d="M2.000 3.750 A3.500 3.500 0 1 0 9.000 3.750 A3.500 3.500 0 1 0 2.000 3.750 Z" />
      <path d="M11.169,20.454a.76.76,0,0,0-.164.563.77.77,0,0,0,.308.533l2.877,2.02a.98.98,0,0,0,1.084.032l7.855-4.878A1.869,1.869,0,0,0,24,17.119a1.793,1.793,0,0,0-.105-.6,1.869,1.869,0,0,0-1.35-1.211h0a1.8,1.8,0,0,0-1.41.269l-2,1.365a.25.25,0,0,1-.228.027l-4.653-1.732a.831.831,0,0,0-.782.112L12.586,16a1.138,1.138,0,0,0-.139.13.823.823,0,0,0-.2.6.856.856,0,0,0,.35.611l2.7,1.67a.251.251,0,0,1,.017.414l-.957.709a.25.25,0,0,1-.276.015l-1.17-.69a.782.782,0,0,0-.747.131l-.867.728A1.227,1.227,0,0,0,11.169,20.454Z" />
    </g>
  ...
  consistency: (
    <g>
      ...
      <path d="M12,4a.5.5,0,0,0-.5.5v7h-7A.5.5,0,0,0,4,12a8,8,0,1,0,8-8Z" />
    </g>
  ),
  clockBold: (
    <g>
  ...
  efficiency: (
    <g>
      <path d="M4.923,16.937a1,1,0,0,0,1.414-1.414A8,8,0,0,1,8.9,2.484a.251.251,0,0,1,.236.024.247.247,0,0,1,.11.211c0,.049,0,.1,0,.147a9.761,9.761,0,0,0,9.75,9.75h.143a.249.249,0,0,1,.211.11.253.253,0,0,1,.024.237,8.044,8.044,0,0,1-2.2,3,1,1,0,1,0,1.295,1.524,10.022,10.022,0,0,0,3.382-5.9,1,1,0,0,0-1.2-1.149,7.752,7.752,0,0,1-9.226-9.226,1,1,0,0,0-1.149-1.2,10,10,0,0,0-5.35,16.922Z" />
      <path d="M15.428,15.916a.746.746,0,0,0-.672-.416h-1.5a.25.25,0,0,1-.25-.25V13a1,1,0,0,0-2,0v2.25a.25.25,0,0,1-.25.25h-1.5a.75.75,0,0,0-.744.848.76.76,0,0,0,.143.351h0l2.753,3.67a.75.75,0,0,0,1.2,0l2.75-3.667a.649.649,0,0,0,.046-.07A.748.748,0,0,0,15.428,15.916Z" />
